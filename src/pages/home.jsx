...
import { Data, Testimonial } from '../components/Data';
      ...
      <main>
          <section className="hero-container">
              <div className="hero">
                ...
                <h4 >With more than 1,111 cryptocurrencies and a total market cap of approximately $151 billion circulating in the market today,</h4>
              ...
              <div className='carousel'>
                <OwlCarousel className="owl-theme" loop autoplay margin={11} items={1} dots={false}>
                  <div class="item">
                    <img src="b-1.png" alt='' />
                  </div>
                  <div class="item">
           ...
           <section className='interest'>
            ...
            <section className='testimonial_container'>
              <div className='testimony'>
                ...
                <OwlCarousel className="owl-theme" loop autoplay margin={11} items={1} dots={false} nav={false} navText={[
